...
Пост 3 (кейс с деталями):
"Что вы знаете о фроде в спортсбуке?
Тема вроде знакомая. Но есть нюанс. Знаете ли, что существует и фрод от букмекера?
Букмекер, ведущий относительно непопулярный вид спорта, выходит со слегка неправильной линией. Через 30-40 минут на это дружно проставляются в кассе через дорогу. Кассир, не нажав кнопку обновления, всё принимает.
Спустя 14 дней после открытия касса закрылась.
Одно я понял на всю жизнь: занимайся бизнесом в той сфере, в которой ты компетентен. Или не жалей денег на делегирование компетентным людям."

ПРАВИЛА СТИЛЯ:
- Пиши ТОЛЬКО на русском. Только отраслевые термины на английском: GGR, NGR, sportsbook, CRM, hold%, CAC, LTV
- НИКАКИХ иероглифов, НИКАКИХ слов на других языках
- Короткие абзацы — 1-3 предложения максимум. Иногда одно слово или фраза — это нормально
...
- Не использовать слова: "недалёкий", "святой грааль", "парадигма"

ТОНЫ:
- expert: аналитический, факты + позиция + острый вывод
- story: личная история или кейс из практики с неожиданной развязкой
- contrarian: берёшь общепринятое мнение в индустрии и разбиваешь его с аргументами

Отвечай ТОЛЬКО текстом поста. Никаких пояснений, заголовков, вводных фраз типа "Вот пост:".`;
}
